<script lang="ts">
	...
	const bg2 =
		typeof section?.secondaryColor === 'string'
...
<section class="relative isolate flex min-h-[70vh] items-center overflow-hidden">
	{#if hasVideo}
		<video
		...
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="mx-auto max-w-3xl py-16 text-center sm:py-24">
				<h1
					...
					style="font-size: var(--h1-font-size); line-height: var(--h1-line-height); font-family: var(--font-heading);"
				>
					{heading}
				</h1>
				{#if subheading}
						...
						{#each actions as a}
							{#if a}
								<a
									...
									class="inline-flex items-center rounded-lg bg-white/10 px-5 py-3 text-white ring-1 ring-white/20 ring-offset-2 ring-offset-black backdrop-blur hover:bg-white/15 focus:outline-none focus-visible:ring-2"
								>
